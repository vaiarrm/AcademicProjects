...
class HistoryTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = addressHistory[indexPath.row]
        return cell
    }
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        ...
        /*
        Deleted a table row and updating NSUserDefaults values
        */
        
        if editingStyle == UITableViewCellEditingStyle.Delete{
            coordToDict[coordinateHistory[indexPath.row]] = nil
            addressHistory.removeAtIndex(indexPath.row)
            coordinateHistory.removeAtIndex(indexPath.row)
